...
use super::{source_image_dimensions, ImageFit, QuarterTurn};
...
pub(crate) fn compute_image_export_layout(
    width_px: u32,
    height_px: u32,
    image_fit: ImageFit,
...
pub fn image_export_preview_layout(
    ...
    let (width_px, height_px) = source_image_dimensions(path)?;
...
#[cfg(test)]
mod tests {
    use super::{compute_image_export_layout, ImageFit};
