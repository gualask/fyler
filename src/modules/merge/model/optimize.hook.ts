...
import type { ImageFit, OptimizeOptions } from './merge.types';
import type { ImageOptimizationPreset } from './optimization.types';
import { DEFAULT_OPTIMIZATION_PRESET, getOptimizationSettings } from './optimization-presets';
