        ...
        >
            ...
            <div onClick={onSelect} className={cardClassName}>
                ...
                <button
                    ...
                    className="btn-icon absolute right-2 top-2 h-7 w-7 rounded-md bg-ui-surface shadow-sm opacity-0 scale-95 pointer-events-none transition-[opacity,transform,color,background-color,box-shadow] hover:bg-ui-surface-hover group-hover:pointer-events-auto group-hover:opacity-100 group-hover:scale-100 group-focus-within:pointer-events-auto group-focus-within:opacity-100 group-focus-within:scale-100"
