...
export const toolbarSelectWrapperClassName =
    'pointer-events-auto relative flex h-11 items-center rounded-xl border border-[color:var(--ui-overlay-border)] bg-[color:var(--ui-overlay-control-strong)] text-[var(--ui-overlay-text)] shadow-[0_12px_32px_var(--ui-overlay-shadow)] backdrop-blur-md';
