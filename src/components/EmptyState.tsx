    ...
    return (
        ...
        >
            <div className="flex h-full w-full flex-col items-center justify-center gap-4 rounded-2xl border-4 border-dashed border-ui-border bg-ui-surface text-center transition-colors group-hover:border-ui-accent/40 group-hover:bg-ui-accent-soft/40">
                <div
                    className="empty-state-enter flex h-20 w-20 items-center justify-center rounded-2xl bg-ui-surface-hover text-ui-text-secondary transition-colors group-hover:bg-ui-accent-soft group-hover:text-ui-accent-on-soft"
                    style={{ animationDelay: '0ms' }}
                >
                    <IconFileUpload className="h-10 w-10 empty-state-breathe" stroke={1.75} />
                </div>
                <p
                    className="empty-state-enter text-2xl font-semibold text-ui-text"
                    style={{ animationDelay: '80ms' }}
                >
                    {t('emptyState.title')}
                </p>
                <p
                    className="empty-state-enter max-w-md text-sm text-ui-text-muted"
